...
{
    public class NoteCreateValidation : FluentValidationBase<NoteCreateInputDto>
    {
        #region Variables
        ...
        public NoteCreateValidation(NoteCreateInputDto dto, IEfUnitOfWork efUnitOfWork) : base(dto)
        {
